...
import static com.rima.model.utilz.Constants.EnemyConstants.EnemyType.ZEN_CHAN;
...
public class ZenChanModel extends EnemyModel {
     ...
     *
     * <p>It also calls the superclass's bubbleCapture method, that created a {@link EnemyBubbleModel} object with inside the ZenChan enemy.
     *
