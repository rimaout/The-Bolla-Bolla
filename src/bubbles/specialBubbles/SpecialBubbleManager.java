...
public class SpecialBubbleManager {
    ...
    private SpecialBubbleManager(PlayerModel playerModel) {
    ...
    public static SpecialBubbleManager getInstance(PlayerModel playerModel) {
        if (instance == null) {
            instance = new SpecialBubbleManager(playerModel);
        }
        return instance;
    }
