...
public class WaterFlow extends Entity {
    ...
    private void moveLeft() {
        ...
        if (!IsSolid(newX, hitbox.y, levelManager.getLevelData()) && !IsSolid(newX, hitbox.y + hitbox.height/2, levelManager.getLevelData()))
            hitbox.x = newX;
        else {
            // change direction
            direction = RIGHT;
    ...
    private void moveRight() {
        ...
        if (!IsSolid(newX + hitbox.width, hitbox.y, levelManager.getLevelData()) && !IsSolid(newX + hitbox.width, hitbox.y + hitbox.height/2, levelManager.getLevelData()))
            hitbox.x = newX;
        else {
            // change direction
            direction = LEFT;
