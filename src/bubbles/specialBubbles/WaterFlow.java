...
public class WaterFlow extends Entity {
    ...
    private void moveLeft() {
        ...
        if (!IsSolid(newX, hitbox.y, level.getLevelData()) && !IsSolid(newX, hitbox.y + hitbox.height/2, level.getLevelData()))
            hitbox.x = newX;
        else {
            // change direction
            direction = RIGHT;
    ...
    private void moveRight() {
        ...
        if (!IsSolid(newX + hitbox.width, hitbox.y, level.getLevelData()) && !IsSolid(newX + hitbox.width, hitbox.y + hitbox.height/2, level.getLevelData()))
            hitbox.x = newX;
        else {
            // change direction
            direction = LEFT;
    ...
    private int calculateEnemyDropY() {
        ...
        for (int i = -1; i < Game.TILES_IN_HEIGHT * Game.TILES_SIZE; i++) {
            if (IsSolid(hitbox.x, dropY, level.getLevelData())) {
